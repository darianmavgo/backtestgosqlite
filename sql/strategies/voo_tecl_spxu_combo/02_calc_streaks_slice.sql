-- Calculate VOO and TECL Down and Up Streaks, and VOO SMA200
WITH diffs AS (
    SELECT
    ...
    FROM backtest_start
    WHERE symbol IN ('VOO', 'TECL') AND length(Date) = 10
),
streaks AS (
    SELECT
        *,
...
INSERT INTO voo_tecl_streaks_slice (idx, symbol, date, open, high, low, close, volume, sma200, down_streak, up_streak)
SELECT
    idx,
    symbol,
    date,
