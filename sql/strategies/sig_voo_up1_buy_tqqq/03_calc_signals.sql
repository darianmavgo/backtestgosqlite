-- BUY TQQQ on every date VOO closed up on higher volume than the prior session.
INSERT INTO sig_voo_up1_buy_tqqq_signals (idx, symbol, date, open, high, low, close, volume, buylimit, entry, direction, regime, hold_days_override, take_profit, stop_loss)
SELECT
...
FROM sig_voo_up1_buy_tqqq_dates_slice d
