...
--   - Main DB: reports/sig-voo-buy-spxu.db (or sig-voo-buy-spxu_4.db) containing equity_curve
--   - Attached DB: data/market_history.db AS market containing backtest_start
--
-- Usage via SQLite CLI:
--   sqlite3 reports/sig-voo-buy-spxu_4.db < sql/strategies/sig_voo_buy_spxu/04_calc_annual_returns_vs_voo.sql
-- ==============================================================================
