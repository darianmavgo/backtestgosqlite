-- Calculate PDD's 200-day SMA and 14-day ATR (simple, unsmoothed average of
...
WITH base AS (
    ...
    FROM backtest_start
    WHERE symbol = 'PDD' AND length(Date) = 10
),
tr AS (
    SELECT
        *,
...
INSERT INTO pdd_tree_features_slice (idx, symbol, date, open, high, low, close, volume, sma200, price_vs_sma200, atr14, range_vs_atr14)
SELECT
