...
INSERT INTO nvdl_tree_signals (idx, symbol, date, open, high, low, close, volume, buylimit, entry, direction, regime, hold_days_override, take_profit, stop_loss)
SELECT
    idx,
    'NVDL' AS symbol,
    date,
