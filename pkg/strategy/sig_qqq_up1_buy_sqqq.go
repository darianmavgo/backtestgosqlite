...
// SigQqqUp1BuySqqq buys SQQQ (3x inverse Nasdaq-100) at the close of any day on
...
func NewSigQqqUp1BuySqqq() *SigQqqUp1BuySqqq {
	s := &SigQqqUp1BuySqqq{TradeSymbol: "SQQQ", TP: 0.08, Hold: 1}
	Register(s)
	RegisterAlias("sigqqqup1buysqqq", s)
	return s
}

func (s *SigQqqUp1BuySqqq) ID() string { return "sig-qqq-up1-buy-sqqq" }

func (s *SigQqqUp1BuySqqq) Name() string { return "QQQ Up+Volume → SQQQ" }

func (s *SigQqqUp1BuySqqq) Description() string {
	return fmt.Sprintf(
...
func (s *SigQqqUp1BuySqqq) Validate() error { return ValidateConfig(s.DefaultConfig()) }

func (s *SigQqqUp1BuySqqq) RequiredSymbols() []string { return []string{"QQQ", s.TradeSymbol} }

func (s *SigQqqUp1BuySqqq) MinHistoryBars() int { return 5 }

func (s *SigQqqUp1BuySqqq) DefaultConfig() StrategyConfig {
...
func (s *SigQqqUp1BuySqqq) ParameterSpace() ParameterSpace {
	cfg := s.DefaultConfig()
